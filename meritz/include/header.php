...
<head>
    ...
    <meta name="keywords"
        content="여행자보험, 여행자보험추천, 여행자보험비교, 국내여행자보험, 여행보험, 해외여행자보험, 해외여행보험, 여행, 해외여행, 국내여행, 휴가, 출장, 유학, 유학생보험, 유학보험, 메리츠화재">

    <meta property="og:title" content="<?=$__SITE_META_TITLE?>">
    <meta property="og:url" content="<?=" https://".$_SERVER["HTTP_HOST"]?>">
    <meta property="og:image" content="<?="
        https://".$_SERVER["HTTP_HOST"]."/travel/meritz/image/common/og_tag_img.jpg"?>" >
    <meta property="og:description" content="<?=$__SITE_META_DESC?>" />

    <link rel="alternate" media="only screen and (max-width: 640px)" href="<?="
        https://".$_SERVER['HTTP_HOST'].str_replace("/travel/meritz/","/travel/meritz/m/",$_SERVER['REQUEST_URI'])?>">
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KR5Q5PM" height="0" width="0"
        ...
        <header>
            <h1>
                <a href="/travel/meritz/index.php">
                    <span>
                        <?php
          if(file_exists($_SERVER['DOCUMENT_ROOT']."/img/logo_meritz.png") && $_SESSION["img_sesstion"] != "Y") {
?>
                        <img src="/img/logo_meritz.png" alt="로고">
                        <?php
          } else if ($_SESSION["img_sesstion"] != "Y") {
?>
                        <img src="/travel/meritz/image/common/meritz-logo.png?e" alt="메리츠화재 로고">
                        <?php
          }
?>
                    </span>
                    <?php
          if($_SESSION["img_sesstion"] != "Y") {
?>
                    <?php
}
?>
                ...
                <a href="https://udirect.co.kr/">
                    <span><img src="/travel/meritz/image/common/Udirect-logo.png" alt="유다이렉트 로고"></span>
                </a>
            </h1>
            <nav>
                <ul class="clearfix inb">
                    <li class="menu02"><a href="/travel/meritz/trip/step0101.php">보험료 계산/가입</a></li>
                    <li class="menu03 <?=($mNum==3)?" active":""?>"><a href="/travel/meritz/check/check.php">가입조회</a>
                    </li>
                    <li class="menu01 <?=($mNum==1)?" active":""?>"><a href="/travel/meritz/life/life_list.php">라이프</a>
                    </li>
                    <li class="menu04 <?=($mNum==4)?" active":""?>"><a href="/travel/meritz/service/faq.php">FAQ</a>
                    </li>
                </ul>
            </nav>
