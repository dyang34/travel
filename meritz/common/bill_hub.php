...
▶ 가입자 : ".$name_text."
▶ 가입플랜 : ".stripslashes($row_mem['plan_title'])."
...
* 해외여행 중 현지에서 사고 발생 시 24시간 한국어 안내가 지원되는 메리츠화재 고객콜센터 82-2-1566-7711로 연락주시면 도움 받으실 수 있습니다.";
								...
								sendTalk_common_notice($kakao_phone, "udirect_common_notice", $msg, "https://".$_SERVER['HTTP_HOST']."/travel/meritz/check/check.php");
