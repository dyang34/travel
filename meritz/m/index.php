...
<?}?>		
	...
	<section id="section03">
		...
		<ul>
			...
			<li class="type-number">4. 해외여행 중 현지에서 사고 발생 시 24시간 한국어 안내가 지원되는 메리츠화재 우리말서비스 82-2-360-2407로 연락주시면 도움 받으실 수 있습니다.</li>
		</ul>
	</section>
	...
	<section id="section04">
		...
		<ul>
			...
			<li class="type-dot">본 계약은 보험계약자를 ㈜유라이프커뮤니케이션즈로 피보험자 및 보험수익자를 ㈜유라이프파이낸셜 회원으로 하는 단체(취급) 여행계약입니다.</li>
			<li class="type-dot">이에 ㈜유라이프커뮤니케이션즈 회원만 피보험자로 가입 가능하며 ㈜유라이프커뮤니케이션즈 회원이 아닌 경우 가입이 불가능합니다.</li>
