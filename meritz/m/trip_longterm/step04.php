...
if ($tripType=="2") {
?>
								<a href="/travel/meritz/files/overseas.pdf" class="button red-line" target="_blank">해외여행보험약관 다운로드</a>
<?php
} else {
?>
								<a href="/travel/meritz/files/domestic.pdf" class="button red-line" target="_blank">국내여행보험약관 다운로드</a>
<?php	
}
?>
							</li>
...
<?php 
require_once $SYS_ROOT_DIR."/travel/meritz/m/modal/agreement.php"; //이용약관	btn-agre
require_once $SYS_ROOT_DIR."/travel/meritz/m/modal/insurance.php"; //보험약관	btn-insu
require_once $SYS_ROOT_DIR."/travel/meritz/m/modal/collective.php"; //개인정보 처리 및 단체가입규약 동의	btn-colle
require_once $SYS_ROOT_DIR."/travel/meritz/m/modal/marketing.php"; //마케팅 활용 동의	btn-mark
require_once $SYS_ROOT_DIR."/travel/meritz/m/modal/privacy.php"; //개인정보수집 및 이용	btn-priv

require_once $SYS_ROOT_DIR."/travel/meritz/m/modal/hospitalize.php"; //입원, 수술, 질병확진 btn-hosp
require_once $SYS_ROOT_DIR."/travel/meritz/m/modal/specific.php"; //특정질병 btn-spec
require_once $SYS_ROOT_DIR."/travel/meritz/m/modal/sports.php"; //위험한 레포츠 btn-sport
require_once $SYS_ROOT_DIR."/travel/meritz/m/modal/restrict.php"; //보험인수 제한 국가 안내 btn-restr
?>
