    ...
    <div class="modal-cont">
      ...
      <div class="content">
        <ul>
          ...
          <li>
            <strong>개인정보 수집 및 이용 및 제3자 제공 동의 (필수)</strong>
          </li>
          <li>
          ...
          <li class="type_dash">
            - 개인정보 보유 및 이용 기간 : <span class="accent">보험기간 종료(귀국일) 후 3년간 보관</span>
          </li>
          <li>
          ...
          <li>
            <strong>고유식별 정보 수집 및 이용제공 및 제3자 제공 동의 (필수)</strong>
          </li>
          <li>
            <b>㈜유라이프파이낸셜 귀중</b>
          </li>
          ...
          <li>
            <span class="accent2">전자우편(E-mail)/우편물(DM)/문자(SMS)/대면접촉/텔레마케팅 등을 활용</span> 등을 활용
          </li>
          <li>
            <span class="accent2">[제휴분야]</span>
          </li>
          <li class="type_number">
