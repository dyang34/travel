...
require_once $SYS_ROOT_DIR."/travel/db/config/get_site_config_member_no.php";
...
if ($term_day < "0") {
	JsUtil::alertReplace("이전 가입 진행 정보가 유효하지 않습니다.\\r\\n\\r\\다시 입력해 주십시오.","/travel/db/m/trip/clear_to_step0101.php");
	exit;
}
...
$(document).on('click','a[name=btnNext]',function() {
	$.ajax({
		type : "POST",
		url : "/travel/db/common_longterm/process_step02.php",
