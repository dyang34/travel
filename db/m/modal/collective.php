        ...
        <div class="modal-cont">
            ...
            <div class="content">
                <ul>
                    ...
                    <li class="type_dash">
                        - 개인정보 수집/제공 목적 : (해외)여행자보험 보험 가입, 가입 취소, 고객문의 응대, 보험가입 고객혜택 제공
                    </li>
                    <li class="type_dash">
                    ...
                    <li class="type_dash">
                        - 개인정보를 수집하는 자 : ㈜유라이프커뮤니케이션즈
                    </li>
                    <li class="type_dash">
                        - 개인정보를 제공받는 자 : <span class="fc-point">DB손해보험㈜</span>, 보험대리점 ㈜비아이에스, 한국신용정보원, SK플래닛㈜
                    </li>
                    <li class="type_dash">
                        - 제공하는 개인정보 항목 : 성명, 이메일, 핸드폰번호, 여행지, 출발일, 귀국일, 여행목적, 보험상품플랜
                    </li>
                    <li class="type_dash">
                        - 개인정보 제공 목적 : (해외)여행보험료 산출 및 가입, 계약관리, 보험가입 고객혜택 제공
                    </li>
                    <li class="type_dash">
                    ...
                    <li class="type_dash">
                        - 개인정보 수집 목적 : (해외)여행자보험 보험 가입, 보험가입 고객혜택 제공
                    </li>
                    <li class="type_dash">
                    ...
                    <li class="type_dash">
                        - 개인정보 수집/제공 목적 : (해외)여행자보험 보험 가입, 보험가입 고객혜택 제공
                    </li>
                    <li class="type_dash">
