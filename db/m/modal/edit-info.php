...
?>
					<li>
						<h3>1. 여행정보
							<a href="./step0101.php" class="button small gray">수정</a>
						</h3>
...
?>
					<li>
						<h3>2. 보험료 계산 결과
							<a href="./step02.php" class="button small gray">수정</a>
						</h3>
...
?>
					<li>
						<h3>3. 피보험자/계약자 정보
							<a href="./step03.php" class="button small gray">수정</a>
						</h3>
					</li>
<?php
				if ($pageStepNo > 4) {
?>
					<li>
						<h3>4. 가입 동의
							<a href="./step04.php" class="button small gray">수정</a>
						</h3>
					</li>
<?php
					if ($pageStepNo > 5) {
