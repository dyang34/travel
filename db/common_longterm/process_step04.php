...
for($i=0;$i<count($arrMember);$i++) {
	...
	$sql_price="select a.plan_code, price, b.plan_title, b.plan_title_src from plan_code_price_longterm a 
				...
				where a.company_type=6 and a.member_no='60000' and a.trip_type='".$tripType."' 
