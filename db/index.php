...
include $SYS_ROOT_DIR.'/travel/db/include/header.php'; 
...
?>
    ...
    <section id="section01">
      <figure>
        <img src="/travel/db/image/common/logo-meritz-col.png?v=<?=time()?>" alt="">
      </figure>
      ...
      <ul class="clearfix ind">
        <li>
          <figure><img src="/travel/db/image/main/departures.png?v=<?=time()?>" alt=""></figure>
          <div class="inner">
            <h2>
        ...
        <li>
          <figure><img src="/travel/db/image/main/travel-and-tourism.png?v=<?=time()?>" alt=""></figure>
          <div class="inner">
            <h2>
        ...
        <li>
          <figure><img src="/travel/db/image/main/customer-service.png?v=<?=time()?>" alt=""></figure>
          <div class="inner">
            <h2>
    ...
    <section id="section03">
      ...
      <div class="box-attention">
        ...
        <ul>
          ...
          <li class="type_dot">
            본 계약은 보험계약자를 ㈜유라이프파이낸셜(서비스: 유다이렉트/이하 “㈜유라이프파이낸셜”)로 피보험자 및 보험수익자를 ㈜유라이프파이낸셜 회원으로 하는 단체(취급) 여행계약입니다.
          </li>
          <li class="type_dot">
            이에 ㈜유라이프파이낸셜 회원만 피보험자로 가입 가능하며 ㈜유라이프파이낸셜 회원이 아닌 경우 가입이 불가능합니다.
          </li>
          <li class="type_dot">
            청약철회
            <ul>
          ...
          <li class="type_dot">
            ㈜유라이프파이낸셜은 해당 상품에 대해 충분히 설명할 의무가 있으며, 가입자는 가입에 앞서 이에 대한 충분한 설명을 받으시기 바랍니다.
          </li>
          <li class="type_dot">
            ㈜유라이프파이낸셜은 메리츠화재로부터 보험계약체결권을 부여받지 아니한 금융상품판매대리·중개업자임을 알려드립니다.
          </li>
		  
		  <!-- /*** 2022.10.26 내용추가 -->
		  <li class="type_dot">㈜유라이프파이낸셜은 다수의 보험사와 계약체결을 대리/중개하는 보험대리점입니다. 보험계약 체결권한은 유라이프대리점에게 있지 않고, 보험사에 있습니다.</li>
          ...
          <li class="type_dot">
            금융소비자보호법에 따른 고지
            <ul>
              <li class="type_dash">㈜유라이프파이낸셜은 인터넷을 이용해 보험상품에 관한 계약체결을 대리,중개하는 금융상품판매대리,중개업자로서 보험회사(메리츠화재해상보험)과 보험모집 위탁계약을 체결하고 있습니다.</li>
              <li class="type_dash">㈜유라이프파이낸셜은 위 보험사들로부터 금융상품계약체결권을 부여받지 않은 경우 금융상품 계약을 체결할 권한이 없으며, 금융소비자보호법위반으로 금융소비자에게 손해를 발생시킨 경우 금융소비자보호법 제 44조 및 제45조에따라 그 손해를 배상할 책임이 있습니다.</li>
              <li class="type_dash">㈜유라이프파이낸셜은 보험사들로부터 금전수령에 관한 권한을 부여받은 경우를 제외하고는 금융소비자가 계약에 따라 지급해야 하는 금전을 수령할 권한이 없으며, 대리,중개시 보험사들로부터 직접판매업자로부터 정해진 수수료 외에 금품 그밖에 재산상 이익을 요구하거나 받을 수 없습니다.</li>
              <li class="type_dash">금융소비자가 제공하는 개인(신용)정보 등은 보험사들이 보유,관리하며, ㈜유라이프파이낸셜은 기타 금융소비자보호법에서 요구하는 금융소비자 보호 또는 건전한 질서유지를 위한 내용을 준수하고 있습니다.</li>
            </ul>
          </li>
