...
if(is_mobile_agent()) {
	header("Location: https://".$_SERVER['HTTP_HOST']."/travel/db/m/");
}
...
<head>
  ...
  <!-- Link Swiper's CSS -->
  <? if($mNum==0): ?>
  <link rel="stylesheet" href="/travel/db/css/swiper-bundle.min.css?v=<?=time()?>">
  <? elseif($mNum==1): ?>
  <link rel="stylesheet" href="/travel/db/css/swiper-sub.min.css?v=<?=time()?>">
  <? elseif($mNum==2): ?>
  <link rel="stylesheet" type="text/css" href="/travel/db/css/jquery-ui.css?v=<?=time()?>">
  <? endif ?>
  <!-- Main CSS -->
  <link rel="stylesheet" type="text/css" href="/travel/db/css/main.css?v=<?=time()?>">
  <!-- Sub CSS -->
  ...
  <script src="/travel/db/js/script.js?v=<?=time()?>"></script>
  <script src="/travel/db/js/jquery-ui.min.js"></script>
  <script type="text/javascript" src="/travel/db/js/common.js?v=<?=time()?>"></script>

<script type="text/javascript" src="/travel/db/js/design.js?v=<?=time()?>"></script>
