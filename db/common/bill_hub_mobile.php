<?
    ...
    include $root_dir."/travel/db/bill_kcp/cfg/site_conf_inc.php";       // 환경설정 파일 include
    require	$root_dir."/travel/db/bill_kcp/pp_cli_hub_lib.php";              // library [수정불가]
...
* 해외여행 중 현지에서 사고 발생 시 24시간 한국어 안내가 지원되는 메리츠화재 우리말서비스 82-2-360-2407로 연락주시면 도움 받으실 수 있습니다.";
								...
								sendTalk_common_notice($kakao_phone, "udirect_common_notice", $msg, "https://".$_SERVER['HTTP_HOST']."/travel/db/m/check/check.php");
